...
import BirthdayNotification from "../components/BirthdayNotification.vue";
...
onMounted(() => {
  ...
  collapsed.value = saved ? saved === "true" : true;
});
...
onMounted(async () => {
  await birthdayStore.fetchToday();
});
</script>
